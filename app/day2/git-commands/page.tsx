...
export default function GitCommandsPage() {
  return (
    <WorkshopLayout
      currentPath="/day2/git-commands"
      title="Git Commands Review"
      nextPath="/day2/github-intro"
      nextTitle="GitHub Interface"
    >
      <div className="max-w-4xl mx-auto">
        {/* Introduction */}
        <Slide title="The Core Workflow">
          <p className="mb-6">
            Let's review the Git workflow. You'll need these commands to push your code to GitHub.
            <strong>Modify → Stage → Commit</strong>.
          </p>
